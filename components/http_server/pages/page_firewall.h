...
h2 { font-size: 1.1rem; font-weight: 500; color: #a78bfa; margin: 1.2rem 0 0.5rem 0; padding-bottom: 0.3rem; border-bottom: 1px solid rgba(167, 139, 250, 0.2); }\
h3 { font-size: 0.95rem; font-weight: 500; color: #a855f7; margin: 0.8rem 0 0.3rem 0; }\
#container { max-width: 900px; margin: 0 auto; padding: 1.5rem; background: rgba(15, 5, 24, 0.96); border-radius: 16px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.4); }\
.data-table { width: 100%; border-collapse: collapse; margin: 0.5rem 0; background: rgba(28, 8, 44, 0.6); border-radius: 8px; overflow: hidden; border: 1px solid rgba(167, 139, 250, 0.15); font-size: 0.8rem; }\
.data-table thead { background: rgba(167, 139, 250, 0.15); }\
.data-table th { padding: 0.4rem 0.2rem; text-align: left; font-weight: 600; color: #a78bfa; font-size: 0.75rem; }\
...
input[type='text'], input[type='number'], select { width: 100%; background: rgba(28, 8, 44, 0.6); border: 1px solid rgba(167, 139, 250, 0.2); border-radius: 6px; color: #cacad8; padding: 0.4rem; font-size: 0.85rem; }\
input:focus, select:focus { outline: none; border-color: #a78bfa; }\
.ok-button { background: linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%); color: #fff; border: none; border-radius: 6px; padding: 0.5rem 1rem; font-size: 0.85rem; font-weight: 600; cursor: pointer; width: 100%; margin-top: 0.25rem; }\
.red-button { background: linear-gradient(135deg, #a855f7 0%, #f5576c 100%); color: #fff; border: none; border-radius: 4px; padding: 0.2rem 0.4rem; font-size: 0.7rem; font-weight: 600; cursor: pointer; text-decoration: none; display: inline-block; }\
...
.acl-section { margin-bottom: 0.5rem; padding: 0.4rem 0.6rem; background: rgba(28, 8, 44, 0.4); border-radius: 10px; border: 1px solid rgba(167, 139, 250, 0.15); }\
...
.modal-box { background: rgba(15, 5, 24, 0.98); border: 2px solid #f5576c; border-radius: 12px; padding: 1.5rem; max-width: 400px; text-align: center; box-shadow: 0 8px 32px rgba(245, 87, 108, 0.3); }\
.modal-box h3 { color: #f5576c; margin-bottom: 1rem; }\
.modal-box p { color: #cacad8; margin-bottom: 1.5rem; }\
.modal-box button { background: linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%); color: #fff; border: none; border-radius: 6px; padding: 0.5rem 1.5rem; font-size: 0.9rem; font-weight: 600; cursor: pointer; }\
</style>\
<body>"
...
<a href='/' style='padding: 0.6rem 1.5rem; background: linear-gradient(135deg, #7c3aed 0%, #5b21b6 100%); color: #fff; border: none; border-radius: 8px; text-decoration: none; font-size: 0.9rem; font-weight: 600;'>🏠 Home</a>\
</div>\
</div>\
</body>\
</html>"
