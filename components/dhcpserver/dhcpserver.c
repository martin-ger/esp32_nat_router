...
static const char *TAG = "custom_dhcps";
...
{
    ESP_LOGI(TAG, "Creating new DHCP server instance (custom implementation)");
...
void __wrap_dhcps_delete(dhcps_t *dhcps)
{
    if (dhcps) {
...
*******************************************************************************/
void *__wrap_dhcps_option_info(dhcps_t *dhcps, u8_t op_id, u32_t opt_len)
{
 ...
 * Returns      : none
*******************************************************************************/
err_t __wrap_dhcps_set_option_info(dhcps_t *dhcps, u8_t op_id, void *opt_info, u32_t opt_len)
{
...
*******************************************************************************/
err_t __wrap_dhcps_set_new_lease_cb(dhcps_t *dhcps, dhcps_cb_t cb, void* cb_arg)
{
    if (dhcps == NULL) {
        return ERR_ARG;
    }
 ...
 * Returns      : none
*******************************************************************************/
err_t __wrap_dhcps_start(dhcps_t *dhcps, struct netif *netif, ip4_addr_t ip)
{
    ESP_LOGI(TAG, "Starting DHCP server on %d.%d.%d.%d (custom implementation)",
 ...
 * Returns      : none
*******************************************************************************/
err_t __wrap_dhcps_stop(dhcps_t *dhcps, struct netif *netif)
{
    ESP_LOGI(TAG, "Stopping DHCP server (custom implementation)");
...
*******************************************************************************/
bool __wrap_dhcp_search_ip_on_mac(dhcps_t *dhcps, u8_t *mac, ip4_addr_t *ip)
{
    struct dhcps_pool *pdhcps_pool = NULL;
    list_node *pback_node = NULL;
    bool ret = false;
...
*******************************************************************************/
err_t __wrap_dhcps_dns_setserver_by_type(dhcps_t *dhcps, const ip_addr_t *dnsserver, dns_type_t type)
{
    if (dhcps == NULL) {
        return ERR_ARG;
    }
 ...
 * Returns      : ERR_ARG if invalid handle, ERR_VAL if invalid type, ERR_OK on success
*******************************************************************************/
err_t __wrap_dhcps_dns_setserver(dhcps_t *dhcps, const ip_addr_t *dnsserver)
{
    return __wrap_dhcps_dns_setserver_by_type(dhcps, dnsserver, DNS_TYPE_MAIN);
}
 ...
 * Returns      : ERR_ARG if invalid handle, ERR_VAL if invalid type, ERR_OK on success
*******************************************************************************/
err_t __wrap_dhcps_dns_getserver_by_type(dhcps_t *dhcps, ip4_addr_t *dnsserver, dns_type_t type)
{
